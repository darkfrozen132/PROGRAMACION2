...
void & operator +=(struct Pedido&,struct Producto&);
void & operator +=(struct Pedido&,struct Cliente&);

//Impresion
ofstream& operator <<(ofstream&,struct Cliente);
ofstream& operator<<(ofstream&,struct Producto);
*/
